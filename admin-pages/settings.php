                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div id="contacto" class="tab-content bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                        ...
                        <div class="mt-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-green-200">
                            <h4 class="font-semibold text-green-900 mb-2">Vista Previa en Header</h4>
                            <p class="text-sm text-green-800 mb-3">Así aparecerá la información en la barra superior:</p>
                            <div class="flex flex-wrap items-center space-x-4 text-sm">
                                <span class="flex items-center text-green-700">
                                    <i class="fas fa-phone mr-2"></i>
                                    <span id="preview-phone"><?php echo htmlspecialchars($settings['contact_phone']); ?></span>
                                </span>
                                <span class="flex items-center text-blue-700">
                                    <i class="fas fa-envelope mr-2"></i>
                                    <span id="preview-email"><?php echo htmlspecialchars($settings['contact_email']); ?></span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="redes" class="tab-content bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                        ...
                        <div class="mt-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200">
                            <h4 class="font-semibold text-purple-900 mb-2">Vista Previa Redes Sociales</h4>
                            <p class="text-sm text-purple-800 mb-3">Así aparecerán en el header superior:</p>
