<?php
// Redirect to new improved register page
header('Location: register-new.php' . (isset($_SERVER['QUERY_STRING']) && !empty($_SERVER['QUERY_STRING']) ? '?' . $_SERVER['QUERY_STRING'] : ''));
exit;
?>
...
require_once 'includes/security-headers.php';
 include 'includes/footer.php'; ?>
    ...
    <script src="<?php
require_once 'includes/security-headers.php';
 echo ASSETS_URL; ?>/js/main.js"></script>
</body>
</html>
