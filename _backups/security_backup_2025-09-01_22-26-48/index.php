...
<body class="font-sans bg-white overflow-x-hidden">
            ...
            <div class="container mx-auto px-4 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 text-xs text-gray-500 font-light opacity-0" id="desktop-logo-makeup">MAKEUP</span>
                    </div>
                ...
                <div class="flex-1 overflow-y-auto py-6">
                    ...
                    <div class="px-6 mb-6">
                        ...
                        <div class="space-y-2">
                            <?php
                            $mobileCategories = [
                                ['name' => 'Rostro', 'icon' => '💄', 'url' => 'categoria.php?cat=rostro'],
                                ['name' => 'Ojos', 'icon' => '👁️', 'url' => 'categoria.php?cat=ojos'],
                                ['name' => 'Labios', 'icon' => '💋', 'url' => 'categoria.php?cat=labios'],
                                ['name' => 'Cejas', 'icon' => '🖌️', 'url' => 'categoria.php?cat=cejas'],
                                ['name' => 'Cuidado', 'icon' => '🌸', 'url' => 'categoria.php?cat=cuidado'],
                                ['name' => 'Herramientas', 'icon' => '✨', 'url' => 'categoria.php?cat=herramientas']
                            ];
                    ...
                    <div class="px-6 mb-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <a href="blog.php" class="flex items-center p-3 rounded-xl hover:bg-secondary-50 transition-colors duration-300 group">
                                <i class="fas fa-newspaper text-secondary-500 mr-4 w-5"></i>
                                <span class="font-medium text-gray-700 group-hover:text-secondary-600">Blog</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="space-y-8" data-aos="fade-right" data-aos-duration="1000">
                        <div class="space-y-6">
                            ...
                            <h1 class="text-5xl lg:text-7xl font-serif font-bold leading-tight text-shadow animate-fade-in-up">
                                ...
                                <br>
                                <span class="text-gray-900">tu belleza</span>
                                <br>
                                <span class="gradient-text">única</span>
                            </h1>
                            ...
                            <p class="text-xl lg:text-2xl text-gray-600 leading-relaxed font-light max-w-lg animate-fade-in-up" style="animation-delay: 200ms;">
                                Explora nuestra colección exclusiva de maquillaje premium y productos de cuidado facial.
                                Desde las últimas tendencias hasta los clásicos atemporales.
                            </p>
                        </div>

                        <div class="flex flex-col sm:flex-row gap-6 animate-fade-in-up" style="animation-delay: 400ms;">
                            <a href="catalogo.php" class="group relative overflow-hidden bg-gradient-to-r from-primary-500 to-secondary-500 text-white px-10 py-5 rounded-2xl font-semibold text-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-center">
                                <span class="relative z-10">Explorar Colección</span>
                                <div class="absolute inset-0 bg-gradient-to-r from-secondary-500 to-primary-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            </a>
                            <a href="ofertas.php" class="group border-2 border-primary-500 text-primary-500 px-10 py-5 rounded-2xl font-semibold text-lg hover:bg-primary-500 hover:text-white transition-all duration-300 text-center relative overflow-hidden">
    ...
    <?php endif; ?>
    <!-- Mobile Hero Section -->
    <section class="md:hidden pt-20 pb-12 mobile-hero-bg relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="text-center mb-8" data-aos="fade-up">
                ...
                <h1 class="text-4xl font-serif font-bold leading-tight mb-4 text-shadow animate-fade-in-up">
                    <span class="gradient-text">Descubre</span>
                    <br>
                    <span class="text-gray-900">tu belleza</span>
                    <br>
                ...
                <p class="text-lg text-gray-600 leading-relaxed font-light mb-6 max-w-sm mx-auto animate-fade-in-up" style="animation-delay: 200ms;">
                    Explora nuestra colección exclusiva de maquillaje premium y productos de belleza.
                </p>

                <div class="flex flex-col space-y-3 max-w-xs mx-auto animate-fade-in-up" style="animation-delay: 400ms;">
                    <a href="catalogo.php" class="bg-gradient-to-r from-primary-500 to-secondary-500 text-white px-8 py-4 rounded-2xl font-semibold text-center hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                        Explorar Colección
                    </a>
                    <a href="ofertas.php" class="border-2 border-primary-500 text-primary-500 px-8 py-4 rounded-2xl font-semibold text-center hover:bg-primary-500 hover:text-white transition-all duration-300">
                        Ver Ofertas
                    </a>
                </div>
            </div>
                    ...
                    <a href="categoria.php?categoria=<?php echo urlencode($slug); ?>" class="block">
                        <div class="relative overflow-hidden rounded-3xl p-8 text-center transition-all duration-500 transform group-hover:-translate-y-4 hover-lift bg-white/80 backdrop-blur-sm border border-white/50 shimmer-effect">
                            ...
                            <div class="relative z-10 mb-6">
                                <div class="w-20 h-20 mx-auto rounded-2xl flex items-center justify-center text-4xl mb-4 group-hover:scale-110 transition-transform duration-300 bg-gradient-to-r <?php echo $iconData['color']; ?> shadow-lg">
    ...
    <section class="md:hidden py-12 bg-gradient-to-br from-luxury-rose/20 via-white to-luxury-gold/20">
        <div class="container mx-auto px-4">
            ...
            <div class="swipe-indicator mb-6" data-aos="fade-up" data-aos-delay="200">
                <div class="flex overflow-x-auto hide-scrollbar space-x-4 pb-4" id="mobile-categories-scroll">
                    <?php
                    foreach ($featuredCategories as $index => $category):
                        $slug = $category['slug'] ?? strtolower(str_replace(' ', '-', $category['name']));
                        $iconData = $elegantCategories[$slug] ?? ['icon' => '✨', 'color' => 'from-gray-400 to-gray-500'];
                    ?>
                    <div class="flex-shrink-0 w-24 animate-fade-in-up" style="animation-delay: <?php echo 300 + ($index * 100); ?>ms;">
                        <a href="categoria.php?categoria=<?php echo urlencode($slug); ?>" class="block">
                            <div class="bg-white/90 backdrop-blur-sm rounded-3xl p-4 text-center mobile-card-shadow hover:shadow-lg transition-all duration-300 border border-white/50">
                                <div class="w-12 h-12 mx-auto rounded-2xl flex items-center justify-center text-2xl mb-3 bg-gradient-to-r <?php echo $iconData['color']; ?> shadow-md">
                                    <span class="filter drop-shadow-sm"><?php echo $iconData['icon']; ?></span>
                                </div>
                ...
                <div class="space-y-8 md:space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-4 group">
                            ...
                            <span class="text-gray-300"><?php echo htmlspecialchars($contactSettings['site_email'] ?? 'contacto@odisea.com'); ?></span>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        window.quickView = function(productId) {
            ...
            // Updated to use details.php instead of product.php
            const url = `details.php?id=${productId}`;
        ...
        window.toggleWishlist = function(productId) {
            ...
            // This function should be implemented based on your wishlist system
        };
